...
- two example characters
  ...
  - [animated](Generic-Character-3D/scenes/AnimatedCharacter.tscn) : An animated character using more of the features this system provides (a closer representation of the average playable character).
