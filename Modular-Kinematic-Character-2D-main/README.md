...
This is an example of the [Modular Character Controller](https://github.com/PantheraDigital/Modular-Character-Controller-for-Godot) within an official Godot Demo. The purpose of this project is to show that the controller works in 2D and how to adapt a script to the Modular Character Controller structure.
